...
%    "assumptions":["..."]}
    ...
    sys = [ ...
        ...
        '7) 如果用户给的是坐标而不是地标名（例如"北3000东2000那里"）：绝不输出坐标数字，' ...
        '改为选择地标表中最接近的地标，并在 assumptions 中明确写出"用户给的是坐标，已改用最近地标 XX"；' ...
        '若地标表里没有合适的地标，则输出空的 segments 数组并在 assumptions 中说明原因；' ...
        '8) 如果用户要求的能力不在上述动作里（例如"飞八字""翻跟头"），不要编造动作：' ...
        '输出空的 segments 数组，并在 assumptions 中说明"暂不支持该动作"。' ...
